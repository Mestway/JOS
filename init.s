...
.LM9:
	...
	xorl	%edx, %edx
	call	mon_backtrace
	.stabn	68,0,20,.LM10-.LFBB1
.LM10:
	movl	%ebx, %esi
	movl	$.LC1, %edi
	xorl	%eax, %eax
	.stabn	68,0,21,.LM11-.LFBB1
.LM11:
	popq	%rbx
	.cfi_def_cfa_offset 8
...
.LC3:
	.string	"\033[1,32m123-%d-%c \033[0m\n"
.LC4:
	.string	"\033[1,31m123-%d-%c \033[0m\n"
.LC5:
	.string	"\033[1,34m123-%d-%c \033[0m\n"
.LC6:
	.string	"\033[32m123-%d-%c \033[0m\n"
.LC7:
	.string	"\033[31m123-%d-%c \033[0m\n"
.LC8:
	.string	"\033[34m123-%d-%c \033[0m\n"
.LC9:
	.string	"\033[42m123-%d-%c \033[0m\n"
.LC10:
	.string	"\033[41m123-%d-%c \033[0m\n"
.LC11:
	.string	"\033[44m123-%d-%c \033[0m\n"
	.text
	.p2align 4,,15
...
.LM33:
	movq	%rdx, %rbx
	.stabn	68,0,83,.LM34-.LFBB3
.LM34:
	je	.L15
	.p2align 4,,10
	.p2align 3
.L13:
	.stabn	68,0,99,.LM35-.LFBB3
.LM35:
	xorl	%edi, %edi
	call	monitor
	jmp	.L13
.L15:
	.stabn	68,0,85,.LM36-.LFBB3
.LM36:
	movq	%rdx, panicstr(%rip)
	.stabn	68,0,88,.LM37-.LFBB3
.LM37:
#APP
# 88 "kern/init.c" 1
	cli; cld
...
#NO_APP
	leaq	224(%rsp), %rax
	.stabn	68,0,91,.LM39-.LFBB3
.LM39:
	movl	%esi, %edx
	movq	%rdi, %rsi
	movl	$.LC12, %edi
	.stabn	68,0,90,.LM40-.LFBB3
.LM40:
	movl	$24, 8(%rsp)
	movl	$48, 12(%rsp)
	movq	%rax, 16(%rsp)
...
.LM46:
	leaq	224(%rsp), %rax
	.stabn	68,0,105,.LM47-.LFBB4
.LM47:
	movq	%rdx, %rbx
	.stabn	68,0,109,.LM48-.LFBB4
.LM48:
	movl	%esi, %edx
	movq	%rdi, %rsi
	movl	$.LC14, %edi
	.stabn	68,0,108,.LM49-.LFBB4
.LM49:
	movl	$24, 8(%rsp)
	movq	%rax, 16(%rsp)
	leaq	32(%rsp), %rax
	movl	$48, 12(%rsp)
	movq	%rax, 24(%rsp)
	.stabn	68,0,109,.LM50-.LFBB4
.LM50:
	xorl	%eax, %eax
	call	cprintf
	.stabn	68,0,110,.LM51-.LFBB4
.LM51:
	leaq	8(%rsp), %rsi
	movq	%rbx, %rdi
	call	vcprintf
	.stabn	68,0,111,.LM52-.LFBB4
.LM52:
	movl	$.LC13, %edi
	xorl	%eax, %eax
	call	cprintf
